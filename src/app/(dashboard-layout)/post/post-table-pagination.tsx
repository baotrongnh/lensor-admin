...
export function PostTablePagination({ table, totalRows }: PostTablePaginationProps) {
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex w-full items-center gap-8 lg:w-fit">
        <div className="hidden items-center gap-2 lg:flex" suppressHydrationWarning>
          ...
          >
            <SelectTrigger size="sm" className="w-20" id="rows-per-page" suppressHydrationWarning>
              <SelectValue
